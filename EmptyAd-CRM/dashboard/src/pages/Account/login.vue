        ...
        <div class="p-5">
          ...
          <n-form ref="formRef" :model="loginInfo" :rules="rules" @submit.prevent="login()">
            <n-form-item class="mb-1" path="email" :label="t('forgot.email')">
              <n-input id="email" v-model:value="loginInfo.email" type="email" autofocus :placeholder="t('forgot.email')" />
            </n-form-item>
            <n-form-item class="mb-1" path="password" :label="t('login.password')">
              <n-input
                id="password" v-model:value="loginInfo.password" type="password" show-password-on="mousedown"
